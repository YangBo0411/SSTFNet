...
class Bottleneck(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = BaseConv(in_channels, hidden_channels, 1, stride=1, act=act)    # 源码
        self.conv2 = Conv(hidden_channels, out_channels, 3, stride=1, act=act)       # 源码
        # self.conv1 = BaseConv(in_channels, hidden_channels, 5, stride=1, act=act)    # yb
        # self.conv2 = Conv(hidden_channels, out_channels, 7, stride=1, act=act)       # yb
