...
class Exp(MyExp):
    def __init__(self):
        ...
        self.num_classes = 1                                                #yb
        self.data_dir = "/home/wuren123/yb/track/other-model/YOLOV/"
        self.train_ann = "/home/wuren123/yb/track/other-model/YOLOV/IRDST/train.npy"        #yb
        self.val_ann = "/home/wuren123/yb/track/other-model/YOLOV/IRDST/val.npy"            #yb
        self.max_epoch = 50
        self.no_aug_epochs = 2
        self.pre_no_aug = 2
        self.warmup_epochs = 1
    ...
    def get_data_loader(
        ...
        dataset = vid.VIDDataset(file_path='/home/wuren123/yb/track/other-model/YOLOV/IRDST/train.npy',
