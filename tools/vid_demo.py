...
def make_parser():
    ...
    parser.add_argument(
        "--path", default="IRDST/Data/1", help="path to images or video"
    )
    ...
    parser.add_argument("-c", "--ckpt", default='YOLOX_outputs/yolov_s_MSSFA_CSCF_SSTA-1-0.927-0.527-0.609/best_ckpt.pth', type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="gpu",
        type=str,
