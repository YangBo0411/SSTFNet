...
def make_parser():
    ...
    parser.add_argument("-c", "--ckpt", default='/data/yb/track/YOLOV-freq/YOLOX_outputs/X-ITSDT-73-1-0.854-0.426-0.497/best_ckpt.pth', type=str, help="checkpoint file")
...
def main(exp, args):
    ...
    # val_loader = exp.get_eval_loader(batch_size=lframe+gframe,is_distributed=False)
