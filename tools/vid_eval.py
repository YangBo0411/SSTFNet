...
def make_parser():
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default='/data/yb/track/YOLOV-freq/exps/yolov/yolov_s.py',
        type=str,
    ...
    parser.add_argument("-c", "--ckpt", default='/data/yb/track/YOLOV-freq/YOLOX_outputs/yolov_s_MSSFA_CSCF_SSTA-1-0.927-0.527-0.609/best_ckpt.pth', type=str, help="checkpoint file")
    parser.add_argument(
        '-data_dir',
        default='',
        type=str,
...
def main(exp, args):
    ...
    dataset_val = vid.VIDDataset(file_path='/data/yb/track/YOLOV-freq/IRDST/val.npy',           # yb  ITSDT /data/yb/old_data/track/dataset/ITSDT-15K/val.npy
